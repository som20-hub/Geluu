...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 1. Background Music & Voice Note Recorder (Immediate priority for instant playback)
  safeRun('Audio System', () => initAudioSystem());

  // 2. Canvas particle background
  safeRun('Particle Engine', () => initParticleEngine());

  // 3. Multi-Page Navigation Controller (Pages 1 to 13)
  safeRun('Navigation', () => initNavigation());

  // 4. 3D Sealed Love Envelope & Letter (Page 2)
  ...
  // 5. Interactive Photo Jigsaw Puzzle (Page 3)
  safeRun('Puzzle', () => initPuzzle("/assets/AS1.jpeg"));

  // 6. Canvas Scratch Cards (Pages 4 & 8)
  ...
  // 7. 4 Distinct Photo Galleries (Pages 5, 7, 9, 11)
